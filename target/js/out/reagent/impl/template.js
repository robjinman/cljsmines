...
var G__12776 = o;
(G__12776[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12784 = jsprops;
(G__12784["defaultValue"] = value);

(G__12784["onChange"] = ((function (G__12784,v,value,on_change){
return (function (p1__12782_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12782_SHARP_);
});})(G__12784,v,value,on_change))
);
...
var vec__12791 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12791,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12791,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12791,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12796 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12796 == null)){
} else {
var key_12797 = temp__4661__auto___12796;
(jsprops["key"] = key_12797);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12799 = (new reagent.impl.template.NativeWrapper());
(G__12799["name"] = c);
...
var G__12801 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12801) : reagent.impl.template.as_element.call(null,G__12801));
} else {
...
var len__7479__auto___12807 = arguments.length;
var i__7480__auto___12808 = (0);
while(true){
if((i__7480__auto___12808 < len__7479__auto___12807)){
args__7486__auto__.push((arguments[i__7480__auto___12808]));

var G__12809 = (i__7480__auto___12808 + (1));
i__7480__auto___12808 = G__12809;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12805){
var G__12806 = cljs.core.first(seq12805);
var seq12805__$1 = cljs.core.next(seq12805);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12806,seq12805__$1);
});
...
break;
default:
var G__12813 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12813;
continue;
...
var n__7319__auto___12816 = a.length;
var i_12817 = (0);
while(true){
if((i_12817 < n__7319__auto___12816)){
(a[i_12817] = reagent.impl.template.as_element((a[i_12817])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7319__auto___12819 = a.length;
var i_12820 = (0);
while(true){
if((i_12820 < n__7319__auto___12819)){
var val_12821 = (a[i_12820]);
if((cljs.core.vector_QMARK_(val_12821)) && ((reagent.impl.template.key_from_vec(val_12821) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12820] = reagent.impl.template.as_element(val_12821));

var G__12822 = (i_12820 + (1));
i_12820 = G__12822;
continue;
} else {
}
...
var ctx = ({});
var vec__12826 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12826,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12826,(1),null);
...
var G__12830 = (cljs.core.count(argv) - first_child);
switch (G__12830) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12830){
