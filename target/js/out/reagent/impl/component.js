...
if((i < len)){
var k = (ks[i]);
var G__12717 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12718 = (i + (1));
m = G__12717;
i = G__12718;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12722 = c;
var G__12722__$1 = (((G__12722 == null))?null:G__12722.prototype);
if((G__12722__$1 == null)){
return null;
} else {
return (G__12722__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12726 = c;
var G__12726__$1 = (((G__12726 == null))?null:G__12726.prototype);
if((G__12726__$1 == null)){
return null;
} else {
return (G__12726__$1["render"]);
}
})()));
});
...
var G__12730 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12730) : reagent.impl.component.as_element.call(null,G__12730));
};
...
var _STAR_current_component_STAR_12737 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12737;
}});
...
var G__12745 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12745) {
...
return ((function (G__12745){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12748 = reagent.impl.component.state_atom(c);
var G__12749 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__12748,G__12749) : cljs.core.reset_BANG_.call(null,G__12748,G__12749));
});
;})(G__12745))
...
var c = this;
var G__12751_12753 = (c["cljsRatom"]);
if((G__12751_12753 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12751_12753);
}
...
var renders_12756 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12757 = cljs.core.first(cljs.core.vals(renders_12756));
if((cljs.core.count(renders_12756) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12756))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12757)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12757], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__12755 = name;
switch (G__12755) {
case "":
...
var elem = (function (){var G__12766 = (function (){var or__6404__auto__ = (function (){var G__12768 = c;
if((G__12768 == null)){
return null;
} else {
return (G__12768["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6404__auto__)){
return or__6404__auto__;
...
return (G__12766["_currentElement"]);
}
})();
var name = (function (){var G__12769 = elem;
var G__12769__$1 = (((G__12769 == null))?null:(G__12769["type"]));
if((G__12769__$1 == null)){
return null;
} else {
return (G__12769__$1["displayName"]);
}
})();
var path = (function (){var G__12770 = elem;
var G__12770__$1 = (((G__12770 == null))?null:(G__12770["_owner"]));
var G__12770__$2 = (((G__12770__$1 == null))?null:reagent$impl$component$component_path(G__12770__$1));
if((G__12770__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12770__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__6404__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__6404__auto__)){
return or__6404__auto__;
} else {
var G__12772 = c;
var G__12772__$1 = (((G__12772 == null))?null:G__12772.constructor);
if((G__12772__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12772__$1);
}
}
})();
