...
if((i < len)){
var k = (ks[i]);
var G__12706 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__12707 = (i + (1));
m = G__12706;
i = G__12707;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12711 = c;
var G__12711__$1 = (((G__12711 == null))?null:G__12711.prototype);
if((G__12711__$1 == null)){
return null;
} else {
return (G__12711__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__12715 = c;
var G__12715__$1 = (((G__12715 == null))?null:G__12715.prototype);
if((G__12715__$1 == null)){
return null;
} else {
return (G__12715__$1["render"]);
}
})()));
});
...
var G__12719 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__12719) : reagent.impl.component.as_element.call(null,G__12719));
};
...
var _STAR_current_component_STAR_12726 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_12726;
}});
...
var G__12734 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__12734) {
...
return ((function (G__12734){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__12737 = reagent.impl.component.state_atom(c);
var G__12738 = f.call(c,c);
...
var c = this;
var G__12740_12742 = (c["cljsRatom"]);
if((G__12740_12742 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12740_12742);
}
...
var renders_12745 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_12746 = cljs.core.first(cljs.core.vals(renders_12745));
if((cljs.core.count(renders_12745) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_12745))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_12746)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_12746], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}
...
var name__$1 = (function (){var G__12744 = name;
switch (G__12744) {
case "":
...
var elem = (function (){var G__12755 = (function (){var or__6404__auto__ = (function (){var G__12757 = c;
if((G__12757 == null)){
return null;
} else {
return (G__12757["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__6404__auto__)){
return or__6404__auto__;
...
return (G__12755["_currentElement"]);
}
})();
var name = (function (){var G__12758 = elem;
var G__12758__$1 = (((G__12758 == null))?null:(G__12758["type"]));
if((G__12758__$1 == null)){
return null;
} else {
return (G__12758__$1["displayName"]);
}
})();
var path = (function (){var G__12759 = elem;
var G__12759__$1 = (((G__12759 == null))?null:(G__12759["_owner"]));
var G__12759__$2 = (((G__12759__$1 == null))?null:reagent$impl$component$component_path(G__12759__$1));
if((G__12759__$2 == null)){
return null;
} else {
return [cljs.core.str(G__12759__$2),cljs.core.str(" > ")].join('');
}
})();
...
var G__12761 = c;
var G__12761__$1 = (((G__12761 == null))?null:G__12761.constructor);
if((G__12761__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__12761__$1);
}
}
})();
