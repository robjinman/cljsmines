...
var x__7067__auto__ = (((rng == null))?null:rng);
var m__7068__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return (m__7068__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto__.call(null,rng));
} else {
var m__7068__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__7068__auto____$1 == null))){
return (m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto____$1.call(null,rng));
} else {
...
var x__7067__auto__ = (((rng == null))?null:rng);
var m__7068__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return (m__7068__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto__.call(null,rng));
} else {
var m__7068__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__7068__auto____$1 == null))){
return (m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto____$1.call(null,rng));
} else {
...
var x__7067__auto__ = (((rng == null))?null:rng);
var m__7068__auto__ = (clojure.test.check.random.split[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return (m__7068__auto__.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto__.call(null,rng));
} else {
var m__7068__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__7068__auto____$1 == null))){
return (m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__7068__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__7068__auto____$1.call(null,rng));
} else {
...
var x__7067__auto__ = (((rng == null))?null:rng);
var m__7068__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__7067__auto__)]);
if(!((m__7068__auto__ == null))){
return (m__7068__auto__.cljs$core$IFn$_invoke$arity$2 ? m__7068__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__7068__auto__.call(null,rng,n));
} else {
var m__7068__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__7068__auto____$1 == null))){
return (m__7068__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__7068__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__7068__auto____$1.call(null,rng,n));
} else {
...
var G__13044 = z;
if(((24) > (function (){var G__13045 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__13045) : clojure.test.check.random.longs.bit_count.call(null,G__13045));
})())){
return clojure.test.check.random.longs.bit_xor(G__13044,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__13044;
}
});
...
var self__ = this;
var this$__$1 = this;
return clojure.test.check.random.doubles.rand_long__GT_rand_double(clojure.test.check.random.rand_long(this$__$1));
});
...
var G__13053 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__13054 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__13053;
ret = G__13054;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__7010__auto__,writer__7011__auto__,opt__7012__auto__){
return cljs.core._write(writer__7011__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__6404__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__13057 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__13057) : cljs.core.atom.call(null,G__13057));
})();
return ((function (a){
return (function (){
...
var map__13059__$1 = ((((!((map__13059 == null)))?((((map__13059.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13059.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13059):map__13059);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13059__$1,cljs.core.cst$kw$state);
var vec__13061 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13061,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13061,(1),null);
...
var args13067 = [];
var len__7479__auto___13070 = arguments.length;
var i__7480__auto___13071 = (0);
while(true){
if((i__7480__auto___13071 < len__7479__auto___13070)){
args13067.push((arguments[i__7480__auto___13071]));

var G__13072 = (i__7480__auto___13071 + (1));
i__7480__auto___13071 = G__13072;
continue;
} else {
}
break;
